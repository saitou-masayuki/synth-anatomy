...
var RECIPES = [
  {
    ...
    steps: [
      ...
      },
      {
        ...
        // 既定値（5ms）は目標（2ms）に近く、既定のtol(0.05)だと触らずに通ってしまうため
        // このステップだけ許容誤差を狭くしてある
        params: { 'ampEnv.attack': 0.002 }, tol: 0.01,
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        // 既定値（18kHz=最大）との正規化距離が約0.102とtolの境界ぎりぎりのため、狭めに設定
        params: { 'filter.cutoff': 9000 }, tol: 0.06,
